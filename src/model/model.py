...
from model.tokenizer import BinaryTokenTree, Token
...
class BinaryTokenTreeModel(nn.Module):
    def __init__(self, embedding_dim: int, hidden_size: int) -> None:
        ...
        self.embedding = nn.Embedding(
            num_embeddings=len(Token.TYPE_LIST),
    ...
    def forward(self, tree: BinaryTokenTree) -> Dict[Token, torch.Tensor]:
        out_map = dict()
        hc_map = dict()
        ...
        for token in tree.to_sorted_list():
